# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-09-11 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('website', '官网'), ('others', '其它')], default='qq', max_length=64, verbose_name='客户来源')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ManyToManyField(blank=True, to='rbac.Role', verbose_name='用户拥有的角色')),
            ],
            options={
                'abstract': False,
            },
